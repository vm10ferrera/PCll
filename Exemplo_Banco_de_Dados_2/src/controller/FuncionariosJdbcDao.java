...
public class FuncionariosJdbcDao {
	...
	public void salvar(Funcionarios f) throws SQLException {
		String sql = "insert into funcionario (nome_func,bairro_func,endereco_func,cep_func,rg_func,cpf_func,email_func,telefone_func) values ('"+f.getNome()+"','"+f.getBairro()+"','"+f.getEndereco()+"','"+f.getCep()+"','"+f.getRg()+"','"+f.getCpf()+"','"+f.getEmail()+"','"+f.getTelefone()+"')";
	...
	public void alterar(Funcionarios f, int id) {
		String sql = "update funcionario set nome_func='"+f.getNome()+"',endereco_func='"+f.getEndereco()+"',bairro_func='"+f.getBairro()+"',cep_func='"+f.getCep()+"',rg_func='"+f.getRg()+"',cpf_func='"+f.getCpf()+"',email_func='"+f.getEmail()+"',telefone_func='"+f.getTelefone()+"'where id_func = '"+id+"';";
		System.out.println(sql);
			...
			try {
				...
				while(rs.next()) {
					...
					Funcionarios Funcionario = new Funcionarios();
					 System.out.println(nome + " " +  endereco + " " + bairro + " " + cep + " " + rg + " " + cpf + " " + telefone + " " + email);
				}
				prepareStatement.close();
			} catch (SQLException e) {
				e.printStackTrace();
